...
$query = "SELECT * FROM vehicle_csv ORDER BY id DESC LIMIT $start_from, $record_per_page";
...
$output .= '
 ...
 ';  //vehicle_csv (userId,userName,car_num,phone,status)
...
$page_query = "SELECT * FROM vehicle_csv  ORDER BY id DESC";
